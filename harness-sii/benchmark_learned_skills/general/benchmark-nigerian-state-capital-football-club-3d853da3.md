...
triggers: 通过州/省成立信息定位足球俱乐部, 线索用州的成立年份范围（1985-1992）、面积范围（3800-5300 sq.km）以及球队赛季战绩特征来锁定俱乐部。, benchmark web question, external evidence lookup, sport.ng.state-capital.club
summary: 线索用州的成立年份范围（1985-1992）、面积范围（3800-5300 sq.km）以及球队赛季战绩特征来锁定俱乐部。
confidence: 0.70
---
# 通过州/省成立信息定位足球俱乐部
...
- Trigger: 线索用州的成立年份范围（1985-1992）、面积范围（3800-5300 sq.km）以及球队赛季战绩特征来锁定俱乐部。
