...
triggers: 动漫/剧集剧情序列识别, 用户描述某外语剧（动漫）特定情节序列：S1主角击败配角对手、揭示力量秘密、S2伪装好人变反派, benchmark web question, external evidence lookup, anime.plot.s1s2.villain-twist
...
4. 第4步：注意输出剧名的常见英文写法；不要把漫画原作和动画版混淆——指aired，所以是动画
