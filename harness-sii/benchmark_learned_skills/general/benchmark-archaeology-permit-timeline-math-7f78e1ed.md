...
triggers: 考古/地产开发事件链与时间倒推, 线索含地产开发停工进行考古、出口许可证年份与样本数量，要求查 13 年前监督试坑的考古公司。, benchmark web question, external evidence lookup, arch.export-permit.pit-minus13y
summary: 线索含地产开发停工进行考古、出口许可证年份与样本数量，要求查 13 年前监督试坑的考古公司。
confidence: 0.70
---
# 考古/地产开发事件链与时间倒推
...
- Trigger: 线索含地产开发停工进行考古、出口许可证年份与样本数量，要求查 13 年前监督试坑的考古公司。
