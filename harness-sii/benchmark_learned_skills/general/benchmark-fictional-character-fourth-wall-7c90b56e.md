...
triggers: 虚构人物特征综合识别, 线索含'打破第四面墙、有得到禁欲苦行者帮助的背景故事、幽默、1960s-1980s 间播出且不到 50 集的电视剧'等组合特征。, benchmark web question, external evidence lookup, fiction.4thwall.monkey-king
summary: 线索含'打破第四面墙、有得到禁欲苦行者帮助的背景故事、幽默、1960s-1980s 间播出且不到 50 集的电视剧'等组合特征。
confidence: 0.70
---
# 虚构人物特征综合识别
...
- Trigger: 线索含'打破第四面墙、有得到禁欲苦行者帮助的背景故事、幽默、1960s-1980s 间播出且不到 50 集的电视剧'等组合特征。
