...
triggers: 短篇教育动画的本地化译名查询, 线索用 1990 年代初首播、单导演双编剧、50-60 集每集<5 分钟、3 字符含数字的电视网、举办过 3 届世界杯但只有 2 届足球的国家来定位节目。, benchmark web question, external evidence lookup, tv.edu.short.1990s.ar-local
summary: 线索用 1990 年代初首播、单导演双编剧、50-60 集每集<5 分钟、3 字符含数字的电视网、举办过 3 届世界杯但只有 2 届足球的国家来定位节目。
confidence: 0.70
---
# 短篇教育动画的本地化译名查询
...
- Trigger: 线索用 1990 年代初首播、单导演双编剧、50-60 集每集<5 分钟、3 字符含数字的电视网、举办过 3 届世界杯但只有 2 届足球的国家来定位节目。
...
4. 第4步：注意需输出'阿根廷发行名'而非原产国原名；不同国家可能有不同译名。
