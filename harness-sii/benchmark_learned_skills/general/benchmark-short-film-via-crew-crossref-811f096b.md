...
triggers: 短片识别（多重剧组+学历线索）, 线索含短片时长、年份、剧情梗概，并通过导演学历和剪辑师另一部作品来交叉锁定时, benchmark web question, external evidence lookup, film.short.2015.teacher-rural
summary: 线索含短片时长、年份、剧情梗概，并通过导演学历和剪辑师另一部作品来交叉锁定时
confidence: 0.70
---
# 短片识别（多重剧组+学历线索）
...
- Trigger: 线索含短片时长、年份、剧情梗概，并通过导演学历和剪辑师另一部作品来交叉锁定时
