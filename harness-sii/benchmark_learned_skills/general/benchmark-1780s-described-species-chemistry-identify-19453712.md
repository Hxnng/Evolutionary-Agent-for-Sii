...
triggers: 生物物种身份识别（命名史+化学成分）, 线索含物种首次描述年代、命名者多领域背景、不被接受的同物异名数量、DNA研究分类调整、亚洲可食用、特定黄烷醇含量, benchmark web question, external evidence lookup, bio.species.1780s.flavonoid-edible
summary: 线索含物种首次描述年代、命名者多领域背景、不被接受的同物异名数量、DNA研究分类调整、亚洲可食用、特定黄烷醇含量
confidence: 0.70
---
# 生物物种身份识别（命名史+化学成分）
...
- Trigger: 线索含物种首次描述年代、命名者多领域背景、不被接受的同物异名数量、DNA研究分类调整、亚洲可食用、特定黄烷醇含量
