...
triggers: 影响者身份多约束识别（节目+代言+家庭排序）, 通过 YouTube vlog、谈话节目主持人（生于 1980 年代）、MIT+商学院出身公司创始人、家中老二等线索定位一位影响者。, benchmark web question, external evidence lookup, person.influencer.ng-host-ambassador
summary: 通过 YouTube vlog、谈话节目主持人（生于 1980 年代）、MIT+商学院出身公司创始人、家中老二等线索定位一位影响者。
confidence: 0.70
---
...
- Trigger: 通过 YouTube vlog、谈话节目主持人（生于 1980 年代）、MIT+商学院出身公司创始人、家中老二等线索定位一位影响者。
...
## Avoid Pitfalls
常见错误是把节目正主持人误填为答案。问的是负责'谈话 segment'的影响者，而非节目本身的 host。