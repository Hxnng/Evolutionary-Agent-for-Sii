...
triggers: 多约束名人身份识别+亲属信息检索, 描述含一位演员/艺人的多个职业里程碑（出道时间、突破作品、导演、获奖动画配音等），最终要求回答其亲属的某项信息, benchmark web question, external evidence lookup, person.actor.sibling.voice-oscar
summary: 描述含一位演员/艺人的多个职业里程碑（出道时间、突破作品、导演、获奖动画配音等），最终要求回答其亲属的某项信息
confidence: 0.70
---
# 多约束名人身份识别+亲属信息检索
...
- Trigger: 描述含一位演员/艺人的多个职业里程碑（出道时间、突破作品、导演、获奖动画配音等），最终要求回答其亲属的某项信息
