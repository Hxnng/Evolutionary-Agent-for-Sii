...
triggers: 金属乐队识别（出道时间+作品序列+巡演支持）, 线索含乐队组建年份、各年作品类型与发行年份、为某知名乐队的某次巡演做开场, benchmark web question, external evidence lookup, music.metal.2013.discography-tour
summary: 线索含乐队组建年份、各年作品类型与发行年份、为某知名乐队的某次巡演做开场
confidence: 0.70
---
...
- Trigger: 线索含乐队组建年份、各年作品类型与发行年份、为某知名乐队的某次巡演做开场
