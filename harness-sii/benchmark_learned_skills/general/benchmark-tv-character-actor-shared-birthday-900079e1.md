...
triggers: 通过角色→演员→同生日运动员的连锁检索, 需从某剧某集中的某个角色出发，经由演员的生日找到一位同生日的归化运动员。, benchmark web question, external evidence lookup, tv.actor.bday.naturalized-athlete
summary: 需从某剧某集中的某个角色出发，经由演员的生日找到一位同生日的归化运动员。
confidence: 0.70
---
# 通过角色→演员→同生日运动员的连锁检索
...
- Trigger: 需从某剧某集中的某个角色出发，经由演员的生日找到一位同生日的归化运动员。
