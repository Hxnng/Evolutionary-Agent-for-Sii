...
triggers: 企业年报具体数字检索, 线索含多条公司特征线索（行业、CEO 言论、董事会决议时间线），要求从特定年度年报中查找精确数据。, benchmark web question, external evidence lookup, corp.powerboat.buyback-remain.2022
summary: 线索含多条公司特征线索（行业、CEO 言论、董事会决议时间线），要求从特定年度年报中查找精确数据。
confidence: 0.70
---
# 企业年报具体数字检索
...
- Trigger: 线索含多条公司特征线索（行业、CEO 言论、董事会决议时间线），要求从特定年度年报中查找精确数据。
...
4. 第4步：注意限定的截止日期（2022-12-31），不要错用 2021 或 2023 年报数据；同时区分 'shares repurchased' 与 'shares remaining available'。
