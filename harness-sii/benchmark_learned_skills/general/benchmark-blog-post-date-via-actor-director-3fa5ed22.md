...
triggers: 通过电影演员/导演反查博主身份并定位博文, 线索用出生月年+演员经历+电影导演出生年+博文内容片段共同锁定一篇博文的发布日期。, benchmark web question, external evidence lookup, media.blogpost.date.actor-bridge
summary: 线索用出生月年+演员经历+电影导演出生年+博文内容片段共同锁定一篇博文的发布日期。
confidence: 0.70
---
...
- Trigger: 线索用出生月年+演员经历+电影导演出生年+博文内容片段共同锁定一篇博文的发布日期。
