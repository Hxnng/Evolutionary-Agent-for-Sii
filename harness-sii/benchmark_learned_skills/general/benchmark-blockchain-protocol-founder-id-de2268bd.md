...
triggers: 区块链/加密项目创始人识别, 线索用协会职务、平台下载量、代币流通、会议出席等多维线索定位某个区块链协议的创始人。, benchmark web question, external evidence lookup, crypto.protocol.founder.fullname
summary: 线索用协会职务、平台下载量、代币流通、会议出席等多维线索定位某个区块链协议的创始人。
confidence: 0.70
---
# 区块链/加密项目创始人识别
...
- Trigger: 线索用协会职务、平台下载量、代币流通、会议出席等多维线索定位某个区块链协议的创始人。
