...
triggers: 作者生平线索反推作品, 题目通过作者的多条传记线索（学历、职业、语言、观点、旅行等）+ 作品属性（首版语言、出版日期、主题、被禁国家）来锁定一本书时, benchmark web question, external evidence lookup
summary: 题目通过作者的多条传记线索（学历、职业、语言、观点、旅行等）+ 作品属性（首版语言、出版日期、主题、被禁国家）来锁定一本书时
confidence: 0.70
---
# 作者生平线索反推作品
...
- Trigger: 题目通过作者的多条传记线索（学历、职业、语言、观点、旅行等）+ 作品属性（首版语言、出版日期、主题、被禁国家）来锁定一本书时
...
## Procedure
1. 第1步：拆解题目为两类约束——作品类（法语首版、2023前出版、对某国的文化分析、在该国被禁）和作者类（两次高考失败1975-1985、与父母同行业工作5年、关于痛苦与写作的观点、1998左右首次到访纽约）
...
## Avoid Pitfalls
容易把作者最有名的作品当作答案，但题目要求的是符合'文化分析+被禁+法语首版'三重约束的特定作品；也容易输出法语原名而非英文译名
