...
triggers: 电竞比赛识别（CS数+比赛时长+选手生日）, 题目给出英雄联盟某场决赛G1的多名选手CS区间、比赛精确时长、某选手生日、年份区间, benchmark web question, external evidence lookup
summary: 题目给出英雄联盟某场决赛G1的多名选手CS区间、比赛精确时长、某选手生日、年份区间
confidence: 0.70
---
...
- Trigger: 题目给出英雄联盟某场决赛G1的多名选手CS区间、比赛精确时长、某选手生日、年份区间
