...
triggers: 入侵物种错认学名查询, 题目提供入侵昆虫的引入年(1916)、扩散历史、最初被错误鉴定，要求给出最初被误认为的物种学名, benchmark web question, external evidence lookup
summary: 题目提供入侵昆虫的引入年(1916)、扩散历史、最初被错误鉴定，要求给出最初被误认为的物种学名
confidence: 0.70
---
# 入侵物种错认学名查询
...
- Trigger: 题目提供入侵昆虫的引入年(1916)、扩散历史、最初被错误鉴定，要求给出最初被误认为的物种学名
