...
triggers: 多跳明星链条（歌手→专辑→歌曲→说唱歌手→演员）, 题目通过歌手生平→专辑命名→同名歌曲→说唱歌手真名→同姓演员→某小说改编电影女主→毕业年份链式推理, benchmark web question, external evidence lookup
summary: 题目通过歌手生平→专辑命名→同名歌曲→说唱歌手真名→同姓演员→某小说改编电影女主→毕业年份链式推理
confidence: 0.70
---
...
- Trigger: 题目通过歌手生平→专辑命名→同名歌曲→说唱歌手真名→同姓演员→某小说改编电影女主→毕业年份链式推理
